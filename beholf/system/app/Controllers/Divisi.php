...
class Divisi extends BaseController
{
    ...
    public function delete_divisi($id)
    {
        ...
        if ($M_divisi->softDelete($id)) {
            ...
            return redirect()->to(base_url('divisi/dihapus_divisi'))->with('success', 'Data divisi berhasil dihapus (soft delete)');
        }
    ...
    public function restore_divisi($id)
    {
        ...
        return redirect()->to(base_url('divisi/dihapus_divisi'))->with('error', 'Data divisi tidak ditemukan');
    }
