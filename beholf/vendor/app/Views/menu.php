    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item <?= ($uri == '' || $uri == 'admin') ? 'active' : '' ?>">
             ...
             <li class="sidebar-item <?= ($uri == 'divisi') ? 'active' : '' ?>">
            ...
            <li class="sidebar-item <?= ($uri == 'level') ? 'active' : '' ?>">
            ...
            <li class="sidebar-item <?= ($uri == 'rapat') ? 'active' : '' ?>">

                <a href="<?= base_url('rapat') ?>" class='sidebar-link'>
