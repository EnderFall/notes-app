...
<head>
    ...
    $dynamicLogo = $webDetail['logo'] ?? 'ellie-logo.jpg';
    ?>
    <title><?= $title . ' - ' . $dynamicTitle ?></title>
    <link rel="icon" href="<?= base_url('assets/dash/img/' . $dynamicLogo); ?>" type="image/x-icon">
    ...
    <script type="text/javascript">
        function googleTranslateElementInit() {
            new google.translate.TranslateElement({
                pageLanguage: 'en',
                includedLanguages: 'en,id,es,fr,de,it,pt,ru,ja,ko,zh,ar,hi',
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/extensions/flatpickr/flatpickr.min.css') ?>" />
