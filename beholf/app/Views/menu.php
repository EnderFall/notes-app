    ...
    <div id="sidebar">
        <div class="sidebar-wrapper active">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="sidebar-header position-relative">
                        <div class="d-flex justify-content-center align-items-center">
                            <?php
                            $webDetailModel = new \App\Models\M_web_detail();
                            $webDetail = $webDetailModel->getWebDetail();
                            $dynamicTitle = $webDetail['title'] ?? 'Ellie Secretary';
                            ?>
                            <h5><?= $dynamicTitle ?></h5>
                        </div>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    <div class="sidebar-profile text-center mt-3 mb-3">
                        <?php
                        $session = session();
                        ...
                        <div class="profile-image mb-2">
                            <a href="<?= base_url('profile') ?>">
                                <img src="<?= base_url('assets/img/' . $foto) ?>" alt="Profile"
                                    class="rounded-circle shadow-sm" width="80" height="80"
                                    style="object-fit: cover; transition: 0.3s; cursor: pointer;"
                    ...
                    if ($user_level) {
                        ...
                        $accessibleForms = $groupFormModel->getFormsByLevel($user_level);
                        foreach ($accessibleForms as $form) {
                            ?>
                            <li class="sidebar-item <?= ($uri == $form['route']) ? 'active' : '' ?>">
                                <a href="<?= base_url($form['route']) ?>" class='sidebar-link'>
                                    <i class="<?= $form['icon'] ?>"></i>
